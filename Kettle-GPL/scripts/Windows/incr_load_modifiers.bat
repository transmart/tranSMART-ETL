...
%KETTLE_DIR%\kitchen.bat /rep:1 /dir="/Metadata" /job:"ETL.metadata.incr_load_modifiers" /user:admin /pass:admin ^
-log=<fully-qualified name of your logs folder>\incr_load_modifiers_%dtStamp%.log ^
