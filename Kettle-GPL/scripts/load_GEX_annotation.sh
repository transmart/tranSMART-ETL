...
set -x
./data-integration/kitchen.sh -norep=Y -file=Kettle-ETL/load_annotation.kjb -log=load_GEX_annotation.log \
...
mv load_GEX_annotation.log logs/load_GEX_annotation_${log_date}.log
