...
%KETTLE_DIR%\kitchen.bat /rep:1 /dir="/Metadata" /job:"ETL.metadata.check_modifiers" /user:admin /pass:admin ^
-log=<fully-qualified name of your logs folder>\check_modifiers_%dtStamp%.log ^
