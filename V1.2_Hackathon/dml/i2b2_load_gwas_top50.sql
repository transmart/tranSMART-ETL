-- Function: tm_cz.i2b2_load_gwas_top50(numeric, numeric)

-- DROP FUNCTION tm_cz.i2b2_load_gwas_top50(numeric, numeric);

CREATE OR REPLACE FUNCTION tm_cz.i2b2_load_gwas_top50(i_bio_assay_analysis_id numeric, currentjobid numeric DEFAULT 0)
  RETURNS integer AS
$BODY$
/*************************************************************************
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tm_cz.i2b2_load_gwas_top50(numeric, numeric) SET search_path=tm_cz, tm_lz, tm_wz, i2b2demodata, i2b2metadata, deapp, biomart, biomart_stage, pg_temp;

ALTER FUNCTION tm_cz.i2b2_load_gwas_top50(numeric, numeric)
  OWNER TO postgres;
