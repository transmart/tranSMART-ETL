...
import fr.sanofi.fcl4transmart.controllers.listeners.geneExpression.SetAttribute2Listener;
...
public class SetAttribute2UI implements WorkItf{
	...
	public SetAttribute2UI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, new SetAttribute2Listener(this.dataType, this));
