...
CREATE OR REPLACE FUNCTION tm_cz.czx_table_index_maint(
	 p_run_type	character varying
	,p_schema character varying
	,p_table character varying default 'ALL'
	,currentJobID 	numeric default null
) RETURNS bigint AS
$BODY$
/*
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tm_cz.czx_table_index_maint(character varying, character varying, character varying, numeric)
