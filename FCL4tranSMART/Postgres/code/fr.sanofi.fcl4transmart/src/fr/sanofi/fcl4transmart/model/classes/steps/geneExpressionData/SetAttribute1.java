...
/**
 *This class represents the step to set the first optional attribute for the sample to subject mapping file
 */	
public class SetAttribute1 implements StepItf{
	private WorkItf workUI;
	private DataTypeItf dataType;
	public SetAttribute1(DataTypeItf dataType){
		this.workUI=new SetAttribute1UI(dataType);
	...
	public String toString(){
		return "Set attribute 1 (optional)";
	}
	public String getDescription(){
		return "This step allows defining an optional attribute for samples.\n"+
