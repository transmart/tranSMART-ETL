...
class AffymetrixNetAffySNPAnnotation {
	...
	Map readNetAffymetrixSNPLine(String line, String fieldSeparator){

		String [] str = line.split(fieldSeparator)
		Map record = [:]
		StringBuffer sbResult = new StringBuffer()
		StringBuffer sbReject = new StringBuffer()
		StringBuffer sbDiscard = new StringBuffer()
	 ...
	 * @return
	 */
	boolean isCorrectFormat(String header, String fieldSeparator){
