-- Function: tm_cz.i2b2_process_rnaseq_data(character varying, character varying, character varying, character varying, numeric)

-- DROP FUNCTION tm_cz.i2b2_process_rnaseq_data(character varying, character varying, character varying, character varying, numeric);

CREATE OR REPLACE FUNCTION tm_cz.i2b2_process_rnaseq_data(trial_id character varying, top_node character varying, source_cd character varying DEFAULT 'STD'::character varying, secure_study character varying DEFAULT 'N'::character varying, currentjobid numeric DEFAULT (-1))
  RETURNS numeric AS
$BODY$
/*************************************************************************
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tm_cz.i2b2_process_rnaseq_data(character varying, character varying, character varying, character varying, numeric) SET search_path=tm_cz, tm_lz, tm_wz, deapp, i2b2demodata, pg_temp;

ALTER FUNCTION tm_cz.i2b2_process_rnaseq_data(character varying, character varying, character varying, character varying, numeric)
  OWNER TO postgres;
