...
import fr.sanofi.fcl4transmart.controllers.listeners.geneExpression.SetSiteIdListener;
 ...
 */
public class SetSiteIdUI implements WorkItf{
	...
	public SetSiteIdUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, new SetSiteIdListener(this.dataType, this));
