...
%KETTLE_DIR%\kitchen.bat /rep:1 /dir="/Metadata" /job:"ETL.metadata.full_load_modifiers" /user:admin /pass:admin ^
-log=<fully-qualified name of your logs folder>\full_load_modifiers_%dtStamp%.log ^
-param:MODIFIER_FILENAME=<filename of modifier file> ^
