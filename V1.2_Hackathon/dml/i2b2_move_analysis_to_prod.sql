CREATE OR REPLACE FUNCTION tm_cz.i2b2_move_analysis_to_prod(
 i_etl_id		numeric
,i_job_id	numeric default 0
)
  RETURNS integer AS
$BODY$
/*************************************************************************
...
set search_path=tm_cz, tm_lz, tm_wz, i2b2demodata, i2b2metadata, deapp, biomart, biomart_stage, pg_temp;
ALTER FUNCTION tm_cz.i2b2_move_analysis_to_prod(numeric, numeric)
  OWNER TO postgres;
