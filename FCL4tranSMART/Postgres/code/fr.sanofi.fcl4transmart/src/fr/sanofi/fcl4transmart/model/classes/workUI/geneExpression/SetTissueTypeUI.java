...
import fr.sanofi.fcl4transmart.controllers.listeners.geneExpression.SetTissueTypeListener;
 ...
 */
public class SetTissueTypeUI implements WorkItf{
	...
	public SetTissueTypeUI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, new SetTissueTypeListener(this.dataType, this));
