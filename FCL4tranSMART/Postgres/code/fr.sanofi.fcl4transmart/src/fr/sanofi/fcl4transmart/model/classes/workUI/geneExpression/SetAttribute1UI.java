...
import fr.sanofi.fcl4transmart.controllers.listeners.geneExpression.SetAttribute1Listener;
 ...
 */
public class SetAttribute1UI implements WorkItf{
	...
	public SetAttribute1UI(DataTypeItf dataType){
	...
	public Composite createUI(Composite parent){
		...
		ok.addListener(SWT.Selection, new SetAttribute1Listener(this.dataType, this));
